...
const char* default_BROKER_MQTT = "40.82.178.10"; // IP do Broker MQTT
...
const int default_DHT_PIN = 15; // Pino do sensor DHT22
const int default_DHT_TYPE = DHT22; // Tipo do sensor DHT
